#!/usr/bin/env python3
"""Activity 2.1.8.1 — synthetic UKB-RAP folder mock (safe for GitHub).

Writes a UK Biobank RAP-style directory with:

- ``phenotypes/ukb_phenotypes.csv`` — cohort table keyed by synthetic ``eid``
- ``genotypes/ukb_la_snps.vcf`` — LA-SNP VCF with sample columns matching ``eid``

All participant identifiers and genotypes are strictly synthetic. No real UKB EIDs.
...
from generate_synthetic_romanian_vcf import (
