...
| Script | Output |
|--------|--------|
| `scripts/figures/generate_methylation_visualizations.py` | Multiple pipeline QA PNGs under `analysis/` |
| `scripts/figures/generate_bimodal_heatmap.py` | `analysis/Fig2_Risk_Heatmap.png` |
| `scripts/figures/generate_clock_validation.py` | `analysis/Fig3_Clock_Validation.png` |
...
| Script | Output | Notes |
|--------|--------|-------|
| `scripts/figures/generate_agent_system_schema.py` | `analysis/Fig4_Agent_System_Schema.png` | Uses Graphviz when `dot` is on `PATH`; matplotlib fallback otherwise |
| `scripts/figures/generate_pipeline_diagram.py` | `analysis/Bioinformatics_Pipeline_Diagram.png` | Requires Graphviz (`brew install graphviz`) |
