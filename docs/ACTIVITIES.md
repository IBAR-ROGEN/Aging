...
| **Output files** | `analysis/Fig_LA_SNP_network.png`, `analysis/Fig_LA_SNP_network.pdf` (per [FIGURES.md](FIGURES.md)) |
...
| **Output files** | `analysis/ukb_snp_manifest_v0.1.csv` (build) · `analysis/la_snp_1kg_frequencies.csv` (extract) · `analysis/la_snp_af_1kg_vs_gnomad.csv`, `analysis/af_1kg_vs_gnomad_scatter.png`, `data/geo/gnomad_r4_nfe_cache.json` (compare) |
