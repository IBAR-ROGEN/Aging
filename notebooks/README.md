...
- After running the public AF pipeline (see **[docs/LA_SNP_PUBLIC_FREQUENCY_PIPELINE.md](../docs/LA_SNP_PUBLIC_FREQUENCY_PIPELINE.md)**), inspect `analysis/la_snp_af_1kg_vs_gnomad.csv`, `figures/af_1kg_vs_gnomad_scatter.png`, and the two-panel publication figure from **`plot_af_comparison.py`** ([docs/AF_COMPARISON_FIGURES.md](../docs/AF_COMPARISON_FIGURES.md)).
